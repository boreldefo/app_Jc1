        ...
        <form id="formregister" action="/index.php" , method="POST">
          ...
          <div>
            ...
            <div class="form-control ">
              ...
              <div class="container-input ">
                <input class="input-auth" type="number" name="tel">
            ...
            <div class="form-control ">
              ...
              <select class="container-input" name="adresse" id="adresse">
                ...
                <option value="Saint EMERENT" selected>Saint EMERENT</option>
            ...
            <div class="form-control ">
              ...
              <select class="container-input" name="codepostal" id="codepostal">
                ...
                <option value="Enfants de Choeur" selected>Enfants de Choeurs</option>
            ...
            <div class="form-control ">
              ...
              <select class="container-input" name="ville" id="ville">
                ...
                <option value="bapteme" selected>Baptême</option>
